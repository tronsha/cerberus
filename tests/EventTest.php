...
class EventTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $input = ':orwell.freenode.net 321 Cerberus Channel :Users  Name';
        $array =  ['text' => 'Users  Name'];
        ksort($array);
        $this->expectOutputString(serialize($array));
        $this->invokeMethod($this->irc, 'command', $input);
    }
    ...
    public function test323()
    {
        $input = ':orwell.freenode.net 323 Cerberus :End of /LIST';
        $array =  ['text' => 'End of /LIST'];
        ksort($array);
        $this->expectOutputString(serialize($array));
        $this->invokeMethod($this->irc, 'command', $input);
    }
    ...
    public function test330()
    {
        $input = ':orwell.freenode.net 330 Cerberus Foo Foobar :is logged in as';
        $array =  ['nick' => 'Foo', 'auth' => 'Foobar', 'text' => 'is logged in as'];
        ksort($array);
        $this->expectOutputString(serialize($array));
        $this->invokeMethod($this->irc, 'command', $input);
    }
    ...
    public function test353()
    {
        $input = ':orwell.freenode.net 353 Cerberus @ #cerberbot :Cerberus @foo bar';
        $array =  ['channel' => '#cerberbot', 'user' => ['Cerberus', '@foo', 'bar']];
        ksort($array);
        $this->expectOutputString(serialize($array));
        $this->invokeMethod($this->irc, 'command', $input);
        $db = $this->irc->getDb();
